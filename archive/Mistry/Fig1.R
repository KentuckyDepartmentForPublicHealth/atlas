...
lab<- d %>% group_by(Tumor) %>% summarize(x = mean(V1), y = mean(V2))
...
p<-ggplot()+geom_point(data=d, aes(V1,V2,color=factor(Tumor)), size=0.75)+theme_pubr()+
...
p1<-ggplot()+
  geom_point(data=d[d$Class2=="Choroid Plexus",],aes(V1,V2,color=Tumor),size=1)+
  ...
  geom_point(data=d[d$Class2=="Diffuse Glioma",],aes(V1,V2,color=Tumor),size=1)+
  ...
  geom_point(data=d[d$Class2=="Discrete Glioma",],aes(V1,V2,color=Tumor),size=1)+
  ...
  geom_point(data=d[d$Class2=="Embryonal",],aes(V1,V2,color=Tumor),size=1)+
...
p2<-ggplot()+
  geom_point(data=d[d$Class2=="Ependymal",],aes(V1,V2,color=Tumor),size=1)+
  scale_color_manual(values=colors[22:27], name="Ependymal")+
  guides(color = guide_legend(override.aes=list(shape = 15, size=5), order = 1))+
  new_scale_color() +
  
  geom_point(data=d[d$Class2=="Germ Cell",],aes(V1,V2,color=Tumor),size=1)+
  scale_color_manual(values=colors[28], name="Germ Cell")+
  guides(color = guide_legend(override.aes=list(shape = 15, size=5), order = 2))+
  new_scale_color() +
  
  geom_point(data=d[d$Class2=="Glioneuronal",],aes(V1,V2,color=Tumor),size=1)+
  scale_color_manual(values=colors[29:30], name="Glioneuronal")+
  guides(color = guide_legend(override.aes=list(shape = 15, size=5), order = 3))+
  new_scale_color() +
  
  geom_point(data=d[d$Class2=="Hematolymphoid",],aes(V1,V2,color=Tumor),size=1)+
  scale_color_manual(values=colors[31], name="Hematolymphoid")+
  guides(color = guide_legend(override.aes=list(shape = 15, size=5), order = 4))+
  new_scale_color() +
  
  geom_point(data=d[d$Class2=="Melanocytic",],aes(V1,V2,color=Tumor),size=1)+
  scale_color_manual(values=colors[32], name="Melanocytic")+
  guides(color = guide_legend(override.aes=list(shape = 15, size=5), order = 5))+
  new_scale_color() +
  
  geom_point(data=d[d$Class2=="Mesenchymal",],aes(V1,V2,color=Tumor),size=1)+
...
p3<-ggplot()+
  geom_point(data=d[d$Class2=="Nerve",],aes(V1,V2,color=Tumor),size=1)+
  scale_color_manual(values=colors[36:39], name="Nerve")+
  guides(color = guide_legend(override.aes=list(shape = 15, size=5), order = 1))+
  new_scale_color() +
  
  geom_point(data=d[d$Class2=="Sellar",],aes(V1,V2,color=Tumor),size=1)+
  scale_color_manual(values=colors[40:41], name="Sellar")+
  guides(color = guide_legend(override.aes=list(shape = 15, size=5), order = 2))+
  new_scale_color() +
  
  geom_point(data=d[d$Class2=="Metastasis",],aes(V1,V2,color=Tumor),size=1)+
  scale_color_manual(values=colors[42:46], name="Metastasis")+
  guides(color = guide_legend(override.aes=list(shape = 15, size=5), order = 3))+
  new_scale_color() +
  
  geom_point(data=d[d$Class2=="Non-tumor",],aes(V1,V2,color=Tumor),size=1)+
